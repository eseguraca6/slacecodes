...
ax.plot(all_waist, linestyle=':', label='HeNe 1f Away', color = 'green')
...
fig.tight_layout()
#fig.savefig(r"C:\Users\pwfa-facet2\Desktop\slacecodes\FACET_model_current\wavelength_runs\tat15mmnoobjectsHeNe.pdf")
