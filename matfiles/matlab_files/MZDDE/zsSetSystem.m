...
DDECommand = sprintf('SetSystem,%i,%i,%i,%i,%1.20g,%1.20g,%i', iSystemData.unitcode, iSystemData.stopsurf, iSystemData.rayaimingtype, iSystemData.useenvdata, iSystemData.temp, iSystemData.pressure, iSystemData.globalrefsurf);
