function PLSF = PLSF(Lambda, w, F, r)
% PLSF(Wavelengths, Wavelength_Weights, Focal_Ratio, Image_Coordinate)
%
% Computes the polychromatic Diffraction Line Spread Function for a number of wavelengths, weights and image coordinates.
% The image coordinate will be in the same length units as that used for the wavelength.
...
Weights = repmat(w, 1, size(mLSF,2));

% Weigh and sum over wavelengths
PLSF = sum(Weights .* mLSF, 1);
