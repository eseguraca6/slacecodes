...
import ZOSAPI.*;
    ...
    apiPath = System.String.Concat(TheApplication.ZemaxDataDir, '\Samples\API\Matlab');
    ...
    SampleFile = System.String.Concat(DataDir, '\Samples\API\Matlab\e17_NSC_BulkScatter.ZMX');
    ...
    oType_data = Object_2.TypeData;
    oType_data.RaysIgnoreObject = ZOSAPI.Editors.NCE.RaysIgnoreObjectType.Always;
    %! [e17s05_m]
    ...
    cfgFile = char(System.String.Concat(DataDir, '\Samples\API\Matlab\e17_NSC_BulkScatter.cfg'));
    ...
    det_cfgFile = System.String.Concat(DataDir, '\Samples\API\Matlab\e17_DetectorViewer.cfg');
...
NET.addAssembly('C:\Program Files\Zemax OpticStudio 16.5 SP5\ZOS-API\Libraries\ZOSAPI_NetHelper.dll');
