...
import ZOSAPI.*;
    ...
    testFile = System.String.Concat(sampleDir, '\Samples\Sequential\Objectives\Double Gauss 28 degree field.zmx');
    ...
    max_rays = 100;
    normUnPolData = raytrace.CreateNormUnpol((max_rays + 1) * (max_rays + 1),c,nsur-1);
    %//! [e22s01_m]
    ...
    nsur = TheSystem.LDE.NumberOfSurfaces;
    max_rays = 100;
    normUnPolData = raytrace.CreateNormUnpol((max_rays + 1) * (max_rays + 1),ZOSAPI.Tools.RayTrace.RaysType.Real,nsur-1);
    %//! [e22s01_m]
