...
import ZOSAPI.*;
    ...
    TheSystem.New(false);
    % Name File
    fileName = System.String.Concat(TheApplication.ZemaxDataDir, '\Samples\API\Matlab\e11_basic_seq.zmx');
...
success = ZOSAPI_NetHelper.ZOSAPI_Initializer.Initialize('C:\Program Files\OpticStudio 16.5 SP5\');
if success == 1
