...
file = r'C:\Users\pwfa-facet2\Desktop\slacecodes\raytracing\nolensfc.zmx'
...
#SAME FOR FIFTH MIRROR
    link.zSetSurfaceParameter(38,3, chief_angle4_x)
    link.zSetSurfaceParameter(38,4, chief_angle4_y)
    link.zSetSurfaceParameter(38,5, 0)
    
    link.zSetSurfaceParameter(44,3, chief_angle4_x)
    link.zSetSurfaceParameter(44,4, chief_angle4_y)
...
#fix
    ...
    link.zSetSurfaceParameter(42, 3, 0) #3 = x-tilt, 4=y-tilt
    link.zSetSurfaceParameter(42, 4, 0)
    link.zSetSurfaceParameter(42, 5, 0)
    
#SAME FOR SIXTH MIRROR
    link.zSetSurfaceParameter(47,3, chief_angle6_x)
    link.zSetSurfaceParameter(47,4, chief_angle6_y)
    link.zSetSurfaceParameter(47,5, 0)
    
    link.zSetSurfaceParameter(53,3, chief_angle6_x)
    link.zSetSurfaceParameter(53,4, chief_angle6_y)
    link.zSetSurfaceParameter(53,5, 0)
#var
    ...
    while status == 'not done':
        ...
        if diff1x < 0.01 and \
           ...
           diff6y < 0.01:
            ...
            c_vec = (1)*misalign_vec + ((1/10)*corr_mem[it-1])
